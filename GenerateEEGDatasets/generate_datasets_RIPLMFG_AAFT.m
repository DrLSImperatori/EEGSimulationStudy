function generate_datasets_RIPLMFG_AAFT(ndatasets, numWorkers) %, dataset_string, interaction)
...
mkdir(['/home/laurai/matlab/Simulations/Conn_BBCB_Results_RIPLMFG_AAFT2_' date_string '/' dataset_string{connkind}])
end
...
if ~exist(['/home/laurai/matlab/Simulations/Conn_BBCB_Results_RIPLMFG_AAFT2_' date_string '/' dataset_string{1} '/dataset_' char(interactionkind(idx))  '_' num2str(snr_index) '_' num2str(idata) '.mat'], 'file');
...
if connkind==1
    ...
    if idx==1
        ...
        Res.truth=truth;
    savetofile(['/home/laurai/matlab/Simulations/Conn_BBCB_Results_RIPLMFG_AAFT2_' date_string '/' dataset_string{1} '/dataset_' char(interactionkind(idx))  '_' num2str(snr_index) '_' num2str(idata) '.mat'], Res);
    else
        Res=struct();
        Res.wpli=wpli;
        Res.wsmi=wsmi;
    ...
    savetofile(['/home/laurai/matlab/Simulations/Conn_BBCB_Results_RIPLMFG_AAFT2_' date_string '/' dataset_string{2} '/dataset_' char(interactionkind(idx))  '_' num2str(snr_index) '_' num2str(idata) '.mat'], Res);
    else
        Res=struct();
        Res.wpli_f=wpli_f;
        Res.wsmi_f=wsmi_f;
